  ...
  return (
    ...
    >
      ...
      <div className="ui-flex ui-flex-col ui-font-favoritpro ">
        <h3 className="ui-text-heading-md md:ui-text-heading-lg ui-text-white ui-whitespace-nowrap ui-text-ellipsis ui-overflow-hidden">{title}</h3>
        {subText && <p className="ui-text-base-sm md:ui-text-base-md ui-text-concrete100 ui-whitespace-nowrap ui-text-ellipsis ui-overflow-hidden">{subText}</p>}
      </div>
    </div>
  )
}
