...
export function Modal({
  ...
  return (
    <Root open {...props}>
      <Portal>
        <Overlay className="ui-fixed ui-inset-0 ui-z-40 ui-bg-[rgba(0,0,0,0.8)] data-[state=open]:ui-animate-in data-[state=closed]:ui-animate-out data-[state=closed]:ui-fade-out-0 data-[state=open]:ui-fade-in-0" />
...
const headingVariants = cva('ui-font-favoritpro ui-text-marbleWhite', {
  variants: {
    size: {
